...
const prices = {
  ...
  [BEDROOMS_2.value]: {
    ...
    [BATHROOMS_4.value]: {
      [REGULAR_CLEANING.value]: 155,
      [DEEP_CLEANING.value]: 290,
      [MOVING_CLEANING.value]: 800,
    },
    [BATHROOMS_5.value]: {
      [REGULAR_CLEANING.value]: 180,
      [DEEP_CLEANING.value]: 320,
      [MOVING_CLEANING.value]: 850,
    },
  },
  [BEDROOMS_3.value]: {
    [BATHROOMS_1.value]: {
    ...
    [BATHROOMS_4.value]: {
      ...
      [DEEP_CLEANING.value]: 300,
      [MOVING_CLEANING.value]: 850,
    },
    [BATHROOMS_5.value]: {
      [REGULAR_CLEANING.value]: 160,
      [DEEP_CLEANING.value]: 330,
      [MOVING_CLEANING.value]: 900,
    },
  },
  [BEDROOMS_4.value]: {
    [BATHROOMS_1.value]: {
    ...
    [BATHROOMS_5.value]: {
      [REGULAR_CLEANING.value]: 180,
      [DEEP_CLEANING.value]: 340,
      [MOVING_CLEANING.value]: 950,
    },
  },
}
